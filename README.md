...
| | 결과 |
|---|---|
| 조리기 가열 시간 | 500회 중앙 **7.8분** (7.6~8.1, 표준편차 0.095) |
| 건조기 건조 시간 | 500회 중앙 **10.8분** (10.3~11.2, 표준편차 0.153) |
| 계획 순서·선택 메뉴 | 800회(200×4상황) **전부 불변** |
| 세척 코스 | 된장찌개 200회 중 **199회 표준** (1회는 오염도가 유난히 높게 나온 회차) |
| 최종 질량비 | 0.7669~0.7800 — 목표 0.78을 **최대 0.013** 지나친다 |

관측 주기를 1분 고정에서 **목표까지 남은 시간에 맞춰 줄이도록** 바꾼 결과,
지나치는 폭이 0.0505 → 0.0131 로 줄었다. 고정 주기였을 때 1인용 냄비(102g)는
0.78 을 노리고 0.5474 에서 끝났다 — 지금은 4.2분에 0.7602 다.
